...
{
	/// <summary>
	///     Registers an implementation of <see cref="IE5EFunctionHandler" /> for the usage with
	///     <see cref="HostExtensions.RegisterEntrypoint{T}" /> and scoped lifetime.
	/// </summary>
	...
	{
		return AddFunctionHandler(services, typeof(T));
	}

	/// <summary>
	///     Registers an implementation of the given type for the usage with
	///     <see cref="HostExtensions.RegisterEntrypoint(Microsoft.Extensions.Hosting.IHost,string,System.Type)" /> and scoped
	///     lifetime.
	/// </summary>
	/// <param name="services">The service collection.</param>
	/// <param name="serviceType">The type of the service.</param>
	/// <exception cref="InvalidOperationException">
	///     Thrown if serviceType is not a class or does not implement
