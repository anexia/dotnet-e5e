...
public record E5ERequestContext
{
	...
	public E5ERequestContext(string type, DateTimeOffset date, bool isAsynchronous, JsonElement? data = null)
	{
		Type = type;
		Date = date;
	...
	/// For example, this attribute may contain the returned object of an authorizer function that was executed before the function.
	/// </summary>
